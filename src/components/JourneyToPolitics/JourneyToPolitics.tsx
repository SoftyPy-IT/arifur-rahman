      ...
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-4">
            A timeline of significant milestones in the life of{" "}
            <span className="font-semibold text-orange-500">Arifur Rahman</span>
            .
          </p>
        </div>
        ...
        <div className="relative border-l-4 border-blue-700">
          ...
          {journeys?.map((journey: TJourneyToPolitics) => (
            <div key={journey?._id} className="mb-10 ml-8">
              ...
              <p className="text-gray-600 mt-2">{journey?.shortDescription}</p>
            </div>
          ))}
        </div>
      </div>
