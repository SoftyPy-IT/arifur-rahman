...
const Articles = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const response = await axiosPublic.get(`articles?page=${currentPage}&limit=${limit}`);
  ...
  return (
    <div className='bg-white mb-20'>
      ...
      <section className='flex justify-center items-center mt-20 mb-10'>
        ...
        <div className='grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center  px-0 '>
