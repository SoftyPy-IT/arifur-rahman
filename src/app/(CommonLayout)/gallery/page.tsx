...
//     }}
//     className={` w-[300px] h-[200px] md:w-[400px] md:h-[260px] bg-[length:100%_100%] bg-contain relative hover:scale-[105%] transition-transform duration-500 lg:w-[600px] lg:h-[400px]`}
//   >
//     {/* Overlay */}
//     <div
